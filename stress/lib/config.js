...
const PROFILES = {
  ...
  standard: {
    ...
    customerCounts: [100, 1000],
    expenseCounts: [100, 1000],
    ledgerCounts: [100, 1000],
    stockProducts: 100,
  ...
  heavy: {
    ...
    customerCounts: [100, 1000, 10000],
    expenseCounts: [100, 1000, 10000],
    ledgerCounts: [100, 1000, 10000],
    stockProducts: 100,
    updatesPerProduct: 10,
...
function loadConfig(argv = process.argv.slice(2)) {
  ...
  return {
    ...
    customers: envInt("STRESS_CUSTOMERS", 10000),
    suppliers: envInt("STRESS_SUPPLIERS", 1000),
    expenses: envInt("STRESS_EXPENSES", 10000),
    ledger: envInt("STRESS_LEDGER", 10000),
    payments: envInt("STRESS_PAYMENTS", 5000),
