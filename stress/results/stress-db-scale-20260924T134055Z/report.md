...
**Report ID:** stress-db-scale-20260924T134055Z
...
| ---: | ---: | ---: | ---: | ---: | --- | --- |
| 100 | 10000 | 10000 | 10000 | 10000 | PASS | PASS (5 writers) |
| 1000 | 10000 | 10000 | 10000 | 10000 | PASS | PASS (50 writers) |
| 5000 | 10000 | 10000 | 10000 | 10000 | PASS | PASS (50 writers) |
...
| ---: | ---: | ---: | ---: | --- |
| 100 | 19 ms | 24 ms | 10000 | PASS |
| 1000 | 18 ms | 22 ms | 10000 | PASS |
| 5000 | 19 ms | 20 ms | 10000 | PASS |
| 10000 | 19 ms | 21 ms | 10000 | PASS |

From size **100** to **10000**, p95 moved from **24 ms** to **21 ms** (about **0.9x**).

### list team members

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 94 ms | 117 ms | 10000 | PASS |
| 1000 | 82 ms | 100 ms | 10000 | PASS |
| 5000 | 102 ms | 121 ms | 10000 | PASS |
| 10000 | 90 ms | 121 ms | 10000 | PASS |

From size **100** to **10000**, p95 moved from **117 ms** to **121 ms** (about **1.0x**).

### owner business list

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 210 ms | 221 ms | 10001 | PASS |
| 1000 | 215 ms | 264 ms | 10001 | PASS |
| 5000 | 241 ms | 282 ms | 10001 | PASS |
| 10000 | 214 ms | 244 ms | 10001 | PASS |

From size **100** to **10000**, p95 moved from **221 ms** to **244 ms** (about **1.1x**).

### search products

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 2 ms | 6 ms | 50 | PASS |
| 1000 | 1 ms | 2 ms | 50 | PASS |
| 5000 | 2 ms | 2 ms | 50 | PASS |
| 10000 | 2 ms | 2 ms | 50 | PASS |

From size **100** to **10000**, p95 moved from **6 ms** to **2 ms** (about **0.3x**).

### barcode lookup

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 1 ms | 1 ms | 1 | PASS |
| 1000 | 1 ms | 1 ms | 1 | PASS |
| 5000 | 1 ms | 1 ms | 1 | PASS |
| 10000 | 1 ms | 1 ms | 1 | PASS |

From size **100** to **10000**, p95 moved from **1 ms** to **1 ms** (about **1.0x**).

### stock aggregate

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 3 ms | 4 ms | 10000 | PASS |
| 1000 | 3 ms | 4 ms | 10000 | PASS |
| 5000 | 3 ms | 4 ms | 10000 | PASS |
| 10000 | 2 ms | 4 ms | 10000 | PASS |

From size **100** to **10000**, p95 moved from **4 ms** to **4 ms** (about **1.0x**).
