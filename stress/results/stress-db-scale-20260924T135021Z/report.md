...
**Report ID:** stress-db-scale-20260924T135021Z
...
Profile: **standard**. Worst-case business id: **11192**.
Connected database verified at runtime: **almadel_stress**.
...
| 1000 | 3 ms | 4 ms | 1000 | PASS |
| 5000 | 17 ms | 18 ms | 5000 | PASS |
| 10000 | 17 ms | 18 ms | 10000 | PASS |

From size **100** to **10000**, p95 moved from **2 ms** to **18 ms** (about **9.0x**).

### list team members

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 6 ms | 9 ms | 100 | PASS |
| 1000 | 13 ms | 15 ms | 1000 | PASS |
| 5000 | 42 ms | 45 ms | 5000 | PASS |
| 10000 | 86 ms | 88 ms | 10000 | PASS |

From size **100** to **10000**, p95 moved from **9 ms** to **88 ms** (about **9.8x**).

### owner business list

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 5 ms | 6 ms | 101 | PASS |
| 1000 | 25 ms | 32 ms | 1001 | PASS |
| 5000 | 116 ms | 129 ms | 5001 | PASS |
| 10000 | 225 ms | 245 ms | 10001 | PASS |

From size **100** to **10000**, p95 moved from **6 ms** to **245 ms** (about **40.8x**).

### search products

| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 4 ms | 7 ms | 50 | PASS |
| 1000 | 3 ms | 3 ms | 50 | PASS |
| 5000 | 2 ms | 4 ms | 50 | PASS |
| 10000 | 1 ms | 2 ms | 50 | PASS |

From size **100** to **10000**, p95 moved from **7 ms** to **2 ms** (about **0.3x**).
...
| Dataset size | Avg | P95 | Rows | Grade |
| ---: | ---: | ---: | ---: | --- |
| 100 | 2 ms | 4 ms | 100 | PASS |
| 1000 | 1 ms | 2 ms | 1000 | PASS |
| 5000 | 3 ms | 5 ms | 5000 | PASS |
